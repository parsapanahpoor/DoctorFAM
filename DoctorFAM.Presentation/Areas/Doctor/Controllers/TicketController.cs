...
{
    public class TicketController : DoctorBaseController
    {
        #region Ctor
        ...
        public async Task<IActionResult> CreateTicket(CreateTicketViewModel create)
        {
            ...
            if (result != 0)
            {
                ...
                return RedirectToAction("TicketDetail", "Ticket", new { area = "Doctor", id = result });
            }
        ...
        public async Task<IActionResult> TicketDetail(AnswerTicketViewModel answer)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                {
                    TempData[SuccessMessage] = _localizer["mission accomplished"].Value;
                    return RedirectToAction("TicketDetail", "Ticket", new { area = "Doctor", id = answer.TicketId });
                }
            }
