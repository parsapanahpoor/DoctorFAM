...
{
    public class TourismNavbarViewComponent : ViewComponent
    {
        #region Ctor
        ...
        public TourismNavbarViewComponent(IUserService userService, IPermissionService permissionService)
        {
        ...
        public async Task<IViewComponentResult> InvokeAsync()
        {
            ...
            return View("TourismNavbar", user);
        }
    }
}
