...
{
    public class HealthCenterPanelNavbarViewComponent : ViewComponent
    {
        #region Ctor
        ...
        public HealthCenterPanelNavbarViewComponent(IUserService userService, IPermissionService permissionService)
        {
        ...
        public async Task<IViewComponentResult> InvokeAsync()
        {
            ...
            return View("HealthCenterPanelNavbar", user);
        }
    }
}
