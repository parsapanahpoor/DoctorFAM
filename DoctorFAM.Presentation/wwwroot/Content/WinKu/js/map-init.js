	...
	"use strict";
		...
		function initialize() {
		  ...
		  map = new google.maps.Map(document.getElementById('map-canvas'),
		      ...
		      infowindow.setContent('<b>مکان من</b><br>تلفن : 46546545');

		      var infowindow2 = new google.maps.InfoWindow();
		      infowindow2.setContent('<b>مکان دیگر</b><br>تلفن : 46546545');

		      var infowindow3 = new google.maps.InfoWindow();
		      infowindow3.setContent('<b>یک مکان دیگر</b><br>تلفن : 46546545');
