...
var customOptions = { twodigit: false, closeAfterSelect: true, nextButtonIcon: "fa fa-arrow-circle-right", previousButtonIcon: "fa fa-arrow-circle-left", buttonsColor: "blue", forceFarsiDigits: true, markToday: true, markHolidays: true, highlightSelectedDay: true, sync: true, gotoToday: true }

$(function () {
    var ids = $("[AdminDatePicker]");
    $(ids).each(function (index, value) {
        $(value).prop("id", "AdminDatePicker" + index);
    });
