...
var customOptions = {
    ...
    gotoToday: true,
    buttonsColor: "#6c757d",
    nextButtonIcon: "zmdi zmdi-caret-right-circle zmdi-hc-lg",
    previousButtonIcon: "zmdi zmdi-caret-left-circle zmdi-hc-lg"
}

$(function () {
    var ids = $("[DatePicker]");
    $(ids).each(function (index, value) {
        $(value).prop("id", "DatePicker" + index);
    });

    $(ids).each(function (index, value) {
        var inputId = $(value).prop('id');
        kamaDatepicker(inputId, customOptions);
    });
});